...
class ModularInverseGUI {
    ...
    ModularInverseGUI() {
        ...
        CalculateModularInverse calculateModularInverse = new CalculateModularInverse(this);
        jButton.addActionListener(calculateModularInverse);

        JFrame jFrame = new JFrame("Modular Inverse");

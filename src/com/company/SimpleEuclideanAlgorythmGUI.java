 ...
 */
class SimpleEuclideanAlgorythmGUI {
    ...
    SimpleEuclideanAlgorythmGUI() {
        ...
        CalculateGCD calculateGCD = new CalculateGCD(this);
        jButton.addActionListener(calculateGCD);

        JFrame jFrame = new JFrame("Simple Euclidean Algorithm");
